...
def tiqu():
	os.system("gnome-terminal -e 'bash -c \"rostopic pub -1 /shoulder_controller/command std_msgs/Float64 -- -1.9; exec bash\"'")	
	os.system("gnome-terminal -e 'bash -c \"rostopic pub -1 /elbow_controller/command std_msgs/Float64 -- -0.3; exec bash\"'")	
	os.system("gnome-terminal -e 'bash -c \"rostopic pub -1 /wrist_controller/command std_msgs/Float64 -- -0.3; exec bash\"'")
	time.sleep(6)
	...
	time.sleep(1)	
	os.system("gnome-terminal -e 'bash -c \"rostopic pub -1 /wrist_controller/command std_msgs/Float64 -- -0.5; exec bash\"'")
...
def fangxia():
	os.system("gnome-terminal -e 'bash -c \"rostopic pub -1 /elbow_controller/command std_msgs/Float64 -- -0.5; exec bash\"'")
	os.system("gnome-terminal -e 'bash -c \"rostopic pub -1 /wrist_controller/command std_msgs/Float64 -- -1.2; exec bash\"'")
	os.system("gnome-terminal -e 'bash -c \"rostopic pub -1 /hand_controller/command std_msgs/Float64 -- -0.4; exec bash\"'")
	time.sleep(9)
	#os.system("gnome-terminal -e 'bash -c \"rostopic pub -1 /waist_controller/command std_msgs/Float64 -- 0.0; exec bash\"'")
	os.system("gnome-terminal -e 'bash -c \"rostopic pub -1 /elbow_controller/command std_msgs/Float64 -- -2.3; exec bash\"'")	
	#os.system("gnome-terminal -e 'bash -c \"rostopic pub -1 /shoulder_controller/command std_msgs/Float64 -- 0.0; exec bash\"'")
	os.system("gnome-terminal -e 'bash -c \"rostopic pub -1 /wrist_controller/command std_msgs/Float64 -- 0.0; exec bash\"'")
	os.system("gnome-terminal -e 'bash -c \"rostopic pub -1 /hand_controller/command std_msgs/Float64 -- 0.0; exec bash\"'")
